    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //Ao registrar um usuário por padrão adiciona a claim "User" e "Desenvolvedor".
                    ...
                    await UserManager.SendEmailAsync(user.Id, "Confirme sua conta.", "Por favor, confirme sua conta clicando no link: <a href=\"" + callbackUrl + "\">link</a>");
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                await UserManager.SendEmailAsync(user.Id, "Redefinir senha", "Por favor, redefina sua senha <a href=\"" + callbackUrl + "\">clicando aqui</a>.");
                ViewBag.Link = callbackUrl;
                return View("ForgotPasswordConfirmation");
            }
